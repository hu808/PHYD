...
import com.example.app01.env.BorderedText;
import com.example.app01.env.ImageUtils;
import com.example.app01.env.Logger;

/**
 * An activity that uses a TensorFlowMultiBoxDetector and ObjectTracker to detect and then track
 * objects.
 */
public class DetectorActivity extends AddVideoActivity implements OnImageAvailableListener {
    ...
    public void onPreviewSizeChosen(final Size size, final int rotation) {
        ...
        previewWidth = size.getWidth()/2;
        previewHeight = size.getHeight()/2;
